...
type ChargeInvoicePaymentMiddleFailureProps = {
...
export function ChargeInvoicePaymentMiddleFailure({
  daysRemaining,
  name,
}: ChargeInvoicePaymentMiddleFailureProps) {
  return (
    <Main>
      ...
      <RoundedSection>
        <Text className="font-heading text-h5 leading-23 text-center pt-32 pb-10 px-25">
          Another failed billing attempt...
        </Text>
        <Text className="text-body-small font-heading text-center pb-24 pt-10 px-25">
          ...
          <br /> We will try again in {daysRemaining} days.
          <br />
          Please refill your funds or update your billing details as soon as
          possible to avoid disabling account access.
        </Text>
        <Divider />
        <Img
