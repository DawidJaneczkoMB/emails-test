...
export function TransactionDeclinedSubsDunningFirst({
  customerServiceMail,
  visualCustomization,
  organizationName,
  transactionDate,
  ...
  amount,
  name,
}: TransactionDeclinedSubsDunningFirstProps) {
  const {
    colorTextParagraphs,
    colorTextHeaders,
    fontParagraphs,
  ...
  return (
    <Main>
      ...
      <RoundedSection>
        ...
        >
          Unfortunately, we could not process your subscription payment. You may
          need to update your billing details.
          <br />
          <br />
          We will try to charge you again over the next few days. After{" "}
          {totalAttempts} retries we will eventually cancel your subscription
        </Text>
        <Divider />
