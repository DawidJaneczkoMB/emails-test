...
type NegativeBalanceReminderProps = {
    ...
    <Main>
      ...
      <RoundedSection>
        ...
        <Text className="text-center pb-24 pt-10 px-25">
          Your invoices for using Payments AI are unpaid. To continue using
          Payments AI, please pay your invoice as soon as possible.
        </Text>
        <Divider />
