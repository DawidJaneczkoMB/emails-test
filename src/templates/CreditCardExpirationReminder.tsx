...
type CreditCardExpirationReminderProps = {
  name: string;
} & OrganizationCustomizableEmailProps;

export function CreditCardExpirationReminder({
  customerServiceMail,
  visualCustomization,
  organizationName,
  name,
}: CreditCardExpirationReminderProps) {
  const {
    colorTextParagraphs,
    colorTextHeaders,
    fontParagraphs,
  ...
  return (
    <Main>
      ...
      <RoundedSection>
        ...
        >
          Your payment card is expiring soon. To avoid any disruption, please
