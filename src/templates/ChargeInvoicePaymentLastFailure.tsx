...
type ChargeInvoicePaymentLastFailureProps = {
  name: string;
};

export function ChargeInvoicePaymentLastFailure({
  name,
}: ChargeInvoicePaymentLastFailureProps) {
  return (
    <Main>
      <HeroSection image="billing-failure-account-disabled.png">
        Hello {name}
      </HeroSection>
      <RoundedSection>
        ...
        <Text className="text-body-small font-heading text-center pb-24 pt-10 px-25">
          We have not been able to charge you for Payments AI over the past few
          days. If you would like to regain access to your account, please
